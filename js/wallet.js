...
// Wallet (solo local / demo)
const WALLET_KEY = "mb_wallet_balance";
...
export function renderBalance(){
  ...
  if(el){ try{ el.textContent = new Intl.NumberFormat('es-AR', {style:'currency', currency:'ARS'}).format(getBalance()); }catch{ el.textContent = getBalance().toFixed(2)+' ARS'; } }
}
